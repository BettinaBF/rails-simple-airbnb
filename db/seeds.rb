...
Flat.create!(
  name: 'Exceptionnal Castle',
  address: '1 Eth  Castle Street, 65012, France ',
  description: 'A huge castle, lost in the middle of nowhere, absolutely perfect for raging parties or a peaceful retreat, might have a ghoul (or ghost?) in the attic.',
  price_per_night: 200,
  number_of_guests: 10
)
